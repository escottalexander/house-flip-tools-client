...
export class EditImprovementElement extends React.Component {
    constructor(props) {
        super(props)
    }
    componentDidMount() {
...
EditImprovementElement = formLink(EditImprovementElement);

export default connect(mapStateToProps)(EditImprovementElement);